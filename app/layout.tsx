...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = { "@context":"https://schema.org", "@graph":[
    ...
    { "@type":"SoftwareApplication", name:"Ribbon UI Studio", operatingSystem:"Windows 10, Windows 11", applicationCategory:"DeveloperApplication", applicationSubCategory:"Microsoft Office RibbonX editor", applicationSuite:"Microsoft Office", description, url:"https://fernand21.github.io/ribbon-ui-studio/", downloadUrl:"https://github.com/fernand21/ribbon-ui-studio/releases/latest", image:"https://fernand21.github.io/ribbon-ui-studio/ribbon-ui-studio-logo.png", offers:{ "@type":"Offer", price:"0", priceCurrency:"USD" }, softwareRequirements:"Microsoft Office desktop; Inno Setup 6 is required only to generate add-in installers." }
  ]};
