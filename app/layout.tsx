...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = { "@context":"https://schema.org", "@graph":[
    { "@type":"WebSite", name:"Ribbon UI Studio", url:"https://fernand21.github.io/office-ribbon-editor/" },
    { "@type":"SoftwareApplication", name:"Ribbon UI Studio", softwareVersion:"2.2", operatingSystem:"Windows 10, Windows 11", applicationCategory:"DeveloperApplication", applicationSubCategory:"Microsoft Office RibbonX editor", applicationSuite:"Microsoft Office", description, url:"https://fernand21.github.io/office-ribbon-editor/", downloadUrl:"https://github.com/fernand21/office-ribbon-editor/releases/latest", image:"https://fernand21.github.io/office-ribbon-editor/ribbon-ui-studio-logo.png", offers:{ "@type":"Offer", price:"0", priceCurrency:"USD" }, softwareRequirements:"Microsoft Office desktop; Inno Setup 6 is required only to generate add-in installers." }
  ]};
